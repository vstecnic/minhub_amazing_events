...
let estimate= extraerEstimate(data.events)
 ...
 //* captura de divs **/ id="hAttendance"  id="lAttendance"
 const hAttendance= document.getElementById("hAttendance")
 const lAttendance = document.getElementById("lAttendance")

 lAttendance.innerHTML="hola"
